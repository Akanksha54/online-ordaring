            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="cta-content">
                        <br>
                        <br>
                        <h2> <em><sup>Rs</sup><?php echo $price; ?></em></h2>
                        <p><?php echo $name; ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-8">
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <img class="d-block w-50" src="<?php echo 'assets/images/products/'.$image; ?>">
                  </div>
                  <!-- <div class="carousel-inner">
              ...
              <div class="col-md-4">
                <div class="contact-form">
                  <form action="cart.php?productid=<?php echo $id; ?>" id="contact" method="post">
