                           ...
                           <!--<div class="row">
                            ...
                            <div class="row">
                               ...
                               <div class="col-sm-6 col-xs-12">
                                    ...
                                    <input type="submit" value="Update" name="storeup">
                                </div>
                           </div>
                           <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <label>Update Phone/ Mobile no.</label>
                                    <input type="submit" value="Update" name="mobileup">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <input type="submit" value="Update" name="addressup">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <label>Update GST no.</label>
                                    <input type="submit" value="Update" name="gstup">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    <input type="submit" value="Update" name="cityup">
                                </div>
